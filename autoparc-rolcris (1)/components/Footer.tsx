...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-white dark:bg-[#050505] border-t border-gray-200 dark:border-white/5 pt-16 pb-24 transition-colors duration-300">
            ...
            <div className="mb-6">
              {!logoError ? (
                ...
                <div className="flex flex-col mb-6">
                  ...
                  <span className="text-sm text-gold-500 font-semibold tracking-[0.2em]">AUTOPARC</span>
                </div>
              )}
            </div>
            ...
            <div className="flex gap-4">
              {socialLinks.map(({ icon: Icon, href }, i) => (
                <a 
                  ...
                  className="w-10 h-10 rounded-full bg-gray-100 dark:bg-white/5 flex items-center justify-center text-gray-600 dark:text-white hover:bg-gold-500 hover:text-black transition-all"
                >
                  <Icon size={18} />
                </a>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={item.name}>
                  <Link to={item.path} className="text-gray-600 dark:text-gray-400 hover:text-gold-500 transition-colors text-sm">
                    {item.name}
                  </Link>
                </li>
              ))}

    ...
    <>
      ...
      {showPrizeModal && holidayPrize && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-pink-950/40 backdrop-blur-md animate-fade-in">
           <div className="relative bg-white w-full max-w-xl rounded-[2rem] border-4 border-pink-200 p-8 shadow-[0_0_100px_rgba(236,72,153,0.6)] flex flex-col items-center text-center overflow-hidden animate-fade-in-up">
              ...
              <button 
                ...
                className="absolute top-4 right-4 bg-pink-100 p-2.5 rounded-full text-pink-600 hover:bg-pink-200 hover:scale-110 transition-all z-30 shadow-sm"
              >
                <X size={24} />
              </button>

              {/* Main Image - Enlarged & Enhanced */}
              <div className="relative z-20 w-full mb-8 group mt-2">
                 ...
                 {/* Floating 3D Emojis */}
                 <div className="absolute -top-6 -right-6 animate-bounce z-30 drop-shadow-xl text-5xl">
                    🎁
                 </div>
                 <div className="absolute -bottom-6 -left-4 animate-bounce delay-1000 z-30 drop-shadow-xl text-5xl">
                    ✨
                 </div>
              </div>

              <div className="space-y-6 relative z-20 w-full">
                 <div className="inline-flex items-center gap-2 bg-pink-100 text-pink-700 px-6 py-2 rounded-full font-bold text-sm uppercase tracking-widest border border-pink-200 shadow-sm transform -translate-y-2">
                    <Gift size={16} /> Surpriză de Valentine's
                 </div>
                 
                 <h2 className="text-4xl md:text-5xl font-display font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-600 to-rose-600 drop-shadow-sm leading-tight">
                 ...
                 <div className="pt-2 w-full">
                    ...
                    >
                      ...
                      <span className="text-xl">Vreau Premiul!</span>
                    </button>
                 </div>
              </div>
           </div>
